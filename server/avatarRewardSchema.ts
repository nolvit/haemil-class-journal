...
export const rewardDDL = [
  ...
  `CREATE TABLE IF NOT EXISTS avatar_orders (id VARCHAR(36) PRIMARY KEY, studentId INT NOT NULL, source VARCHAR(20) NOT NULL DEFAULT 'student_order', status VARCHAR(20) NOT NULL, refundReason VARCHAR(140) NULL, price INT NOT NULL, input TEXT NOT NULL, prompt TEXT NOT NULL, masterUrl TEXT NOT NULL, createdAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX avatar_order_student(studentId, createdAt))`,
...
export const rewardSchemaUpgrades = [
  ...
  },
  {
    table: "avatar_orders",
    column: "refundReason",
    sql: "ALTER TABLE avatar_orders ADD COLUMN refundReason VARCHAR(140) NULL AFTER status",
  },
  {
