...
// 않을 수 있다.
const CACHE_NAME = "haemil-shell-v16-pwa-notification-state";
const APP_SHELL = [
  "/",
  "/check-in",
  "/admin.webmanifest",
  ...
  "/parent.webmanifest",
  "/icons/haemil-logo-192.png",
  "/icons/haemil-logo-512.png",
...
self.addEventListener("fetch", event => {
  ...
  if (new URL(event.request.url).pathname.startsWith("/avatar-rewards/"))
    return;
  if (
