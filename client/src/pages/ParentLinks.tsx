...
type Student = { id: number; name: string; grade: string; publicToken: string; portalEnabled: boolean; monthlyViewCount: number; classGroups: Array<{ id: number; name: string }> };
